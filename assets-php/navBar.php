...
<nav>
    <div id="mobile"><a href="/index.php"><img id="logomobile" src="/assets-img/Illustration-sans-titre-4.png" alt="Illustration-sans-titre-1" border="0"></a> </div>

    <a href="/index.php"><img id="logo" src="/assets-img/Illustration-sans-titre-4.png" alt="Illustration-sans-titre-1" border="0"></a>
    ...
    <script>
        function changeImagepc() {
            if (document.getElementById("logo").src=="/assets-img/Illustration-sans-titre-4.png") {
                document.getElementById("logo").src="/assets-img/pngwing-com-1.png"

            } else if (document.getElementById("logo").src=="/assets-img/pngwing-com-1.png") {
                document.getElementById("logo").src="/assets-img/Illustration-sans-titre-4.png"
            }
        }

        function changeImageMobile() {

            if (document.getElementById("logomobile").src=="/assets-img/Illustration-sans-titre-4.png") {
                document.getElementById("logomobile").src="/assets-img/pngwing-com-1.png"

            } else if (document.getElementById("logomobile").src=="/assets-img/pngwing-com-1.png") {
                document.getElementById("logomobile").src="/assets-img/Illustration-sans-titre-4.png"
            }
